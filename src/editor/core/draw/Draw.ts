...
export class Draw {
        ...
        for (let i = 0; i < elementList.length; i++) {
            ...
            if (isWrap) {
                ...
                if (
                    ...
                    rowElement.control?.indentation ===
                        ControlIndentation.VALUE_START
                ) {
                    // 查找到非前缀的第一个元素位置
            ...
            for (let j = 0; j < curRow.elementList.length; j++) {
                ...
                if (element.type === ElementType.IMAGE) {
                    ...
                    if (
                        ...
                        this.spaceSymbolParticle.render(
                            ctx,
                            element,
                            x,
                            y + curRow.height / 2,
                ...
                if (
                    ...
                    if (
                        curRow.elementList[j]?.type &&
                        curRow.elementList[j].type === ElementType.TAB
                    )
    ...
    public calculateFormula(
        elementList?: IElement[],
        formulaTableElementIndex?: number,
        isAccepted?: boolean,
        trIndex?: number,
        tdIndex?: number,
    ...
    public editFormula() {
        ...
        const formulaString: IElement[] = formulaElement.formula
            ...
            .map((elem: string) => {
                return {
                    id: formulaElement?.value[0].id,
                    tableId: formulaElement?.value[0].tableId,
                    tdId: formulaElement?.value[0].tdId,
