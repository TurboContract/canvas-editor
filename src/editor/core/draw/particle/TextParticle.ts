...
export class TextParticle {
    ...
    private showInvisibleChars?: boolean
    ...
    constructor(draw: Draw) {
        ...
        this.showInvisibleChars = true
    }

    public setShowInvisibleChars(show: boolean) {
        this.showInvisibleChars = show
    }

    private replaceInvisibleChars(value: string): string {
        if (!this.showInvisibleChars) return value
    ...
    public record(
        ...
        const value = this.replaceInvisibleChars(element.value)
        this.ctx = ctx
        // 兼容模式立即绘制
